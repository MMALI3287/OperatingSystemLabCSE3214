    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfProcesses; i++) {
            ...
            for (int j = 0; j < numberOfProcesses; j++) {
                if (!processes[j].isFinished && currentTime >= processes[j].arrivalTime
            ...
            if (shortestJobIndex != -1) {
                ...
                processes[shortestJobIndex].completionTime = Math.max(currentTime, processes[i].arrivalTime);
                processes[shortestJobIndex].turnaroundTime = processes[shortestJobIndex].completionTime
